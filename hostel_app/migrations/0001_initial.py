# Generated by Django 2.2.6 on 2019-10-31 18:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='hostel_app.Room')),
        ...
        migrations.AddField(
            model_name='hostel',
            name='mess',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='hostel_app.Mess'),
        ),
    ]
